<template>
  <div class="device-map-main-container">
    ...
    <div class="center-container">
      <center-page :scenceId="scenceId" :defaultActive="2">
        <device-list 
...
import DeviceList from '@/views/deviceMapManagement/components/deviceList'

export default {
  components: {
    ComponentsManager, OptionsManager, DeviceList, CenterPage
  },
  props: {
    scenceId: {
      type: Number,
